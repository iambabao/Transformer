...
class Config:
    def __init__(self, root_dir, current_model,
                 ...
                 max_seq_length=128, word_em_size=512,
                 hidden_size=512, attention_size=256,
                 kernel_size=(2, 3, 4, 5), filter_dim=64,
                 num_layer=4, num_head=8, model_dim=512,
        ...
        self.cached_train_data = os.path.join(self.data_dir, 'data_train.cache')
        self.valid_data = os.path.join(self.data_dir, 'data_valid.txt')
        self.cached_valid_data = os.path.join(self.data_dir, 'data_valid.cache')
        self.test_data = os.path.join(self.data_dir, 'data_test.txt')
        self.cached_test_data = os.path.join(self.data_dir, 'data_test.cache')
        ...
        self.src_2_id, self.id_2_src = {}, {}
        self.tgt_2_id, self.id_2_tgt = {}, {}
        self.to_lower = True
